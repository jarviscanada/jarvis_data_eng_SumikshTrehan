...
* Expertise in DAX and Data Architecture: By developing complex DAX measures for time-series forecasting and year-over-year growth analysis, he provided stakeholders with a sophisticated analytical dashboard measuring the ticketing system perfomance at Ontario Public Service.

* Domain-Specific QA Intelligence: With a comprehensive understanding of the SDLC and testing fundamentals for 4 goverment programs at Ontario Public Service, he doesn't just build dashboards but he also understands end to end project. He is uniquely capable of designing reporting suites that specifically track defect density and test execution health.

* Agile Leadership and the PM Mindset: His experience working with Banking and Goverment allows him to bridge the gap between data and delivery. He facilitated daily stand-ups, identify POD blockers, and drive team velocity, ensuring data directly supports project timelines.

* Proven Record of Optimization: He has a demonstrated history of increasing reporting efficiency by 20% through automation during his previous work experience.
...
## Education
**Seneca Polytechnic College (2023-2025)**, Honours Bachelor of Technology - Software Development(BSD), Electrical and Computer Engineering
- Scholarship
- Dean's List
- GPA: 3.8/4.0

**Seneca Polytechnic College (2020-2023)**, Diploma - Computer Programming, Electrical and Computer Engineering
- Scholarship
- GPA: 3.2/4.0

**Georgian College (2015-2017)**, Diploma - Electrical Engineering, Electrical Engineering
- Scholarship
- GPA: 3.8/4.0
